...
public class GraphResultActivity extends Activity {
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(GraphResultActivity.this);
        ...
        protected String doInBackground(String... params) {  //프로그레스 다이얼로그 자동 종료 및 에러메시지 토스트보여줌
            ...
            try {
                ...
                Log.d("GraphResult", "GraphResult 0-0: " + conn.getResponseCode());
                ...
                if (response_code == HttpURLConnection.HTTP_OK) {
                    ...
                    Log.d("GraphResult", "GraphResult 2: " + result.toString());  // result.toString()
                    Log.d("GraphResult", "GraphResult 2-1: " + reader);    //java.io.BufferedReader@5015f88
                    ...
                    Log.d("GraphResult", "GraphResult 2-2: " + sendImagePath);
                    Log.d("GraphResult", "GraphResult 2-3: " + resultImagePath);
                    Log.d("GraphResult", "GraphResult 2-4: " + resultType);
                    Log.d("GraphResult", "GraphResult 2-5: " + userName);
        ...
        protected void onPostExecute(String result) {
            ...
            if(isNetworkAvailable()){
                ...
                Log.d("GraphResult", "GraphResult 3-1" + resultImagePath);
                downloadTask.execute("http://113.198.84.37/" + resultImagePath);
                Log.d("GraphResult", "GraphResult 3-2" + resultImagePath);
            }else{
    ...
    public void displayImageView(String ImagePath) {
        try {
            ...
            Log.d("GraphResult", "GraphResult 4-1: " + "http://113.198.84.37/" + ImagePath);
